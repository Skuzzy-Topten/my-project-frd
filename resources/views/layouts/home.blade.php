...
<head>
    ...
    <!-- transition css -->
    <link rel="stylesheet" href="transition/css/transition.min.css">
    <link rel="stylesheet" href="transition/css/transition.wipes.min.css">
    <style>
...
<main>
    @yield('banner')
    @yield('post-news')
    @yield('post-announcement-and-information')
    @yield('videos')
</main>
<footer>
